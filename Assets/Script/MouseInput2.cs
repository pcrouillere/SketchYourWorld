...
public class MouseInput2 : FGInputProvider
{
	...
	{
		down = Input.GetMouseButton( fingerIndex ) || SixenseInput.Controllers[0].GetButton(SixenseButtons.TRIGGER);
		position = PointCloud.gPointCloud.DrawHand(GameObject.Find("HandR").transform.position);
		//position = Input.mousePosition;

		//Debug.Log ("down" + down + " pos :" + position.x + " " + position.y);
