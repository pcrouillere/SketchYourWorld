...
//#  
//&-----------------------------------------------------------------------------
Shader "echoLogin/Transparent/FX/Ripple"
{
	Properties 
	{
		...
		_echoRGBA ( "RGB Multiply", Vector )	= ( 1, 1, 1, 1 )    
   		...
   		_echoHeight ("Wave Height", Range ( 0.0, 64.0 ) )		= 4
	...
	SubShader 
	{
		...
		{    
			...
			Varys vert ( VertInput  ad )
			{
				...
				{
					float ripple;
					ripple 			= EchoRipple ( ad.texcoord, _echoAmount, _echoSpeed, _echoHeight * ( ad.color.w ), _echoCenterX, _echoCenterY  );
