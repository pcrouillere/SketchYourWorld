//$-----------------------------------------------------------------------------
//@ Lighted Shader		- Bumpmap with lightmap texture
//@
...
//#  
//&-----------------------------------------------------------------------------
Shader "echoLogin/Light/BumpMap/20-lightmap"
{
   	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue" = "Geometry+10" "IgnoreProjector"="False" "RenderType"="echoLight" }
